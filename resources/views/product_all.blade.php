...
@section('content')
    ...
    @if (count($products) != 0)
        ...
        <div class="container my-5 product-all">
            ...
            <a href="{{url("/category/{$cat}/all")}}" class="text-decoration-none ps-3">All products for this category</a>
        ...
        <div class="container-fluid px-0 search-form-bottom d-flex justify-content-center align-items-center">
            <div class="card" style="width: 80%">
                <div class="card-header py-3 text-center">
                    <strong class="text-danger mt-2"> &#9785; This category of products Not Found!</strong> 
                </div>
            </div>
        </div>
    @endif
